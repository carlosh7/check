...
| 0.5 | Secretos débiles shipeados | Detectar placeholder `genera_una_clave_unica` en arranque → generar JWT_SECRET fuerte automáticamente; primer login fuerza cambio de `ADMIN_PASSWORD`. | S |
