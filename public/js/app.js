...
const App = window.App = {
    ...
    editSelectedClients: function(clientIds) {
        ...
        Swal.fire({ title: '', html, width: '460px', background: bgMain, color: textMain, showConfirmButton: false, showCloseButton: false, position: 'center-start', customClass: { popup: 'rounded-[1.5rem] shadow-2xl' } });
    },
    ...
    editSingleClient: function(clientIds) {
        ...
        Swal.fire({ title: '', html, width: '520px', background: bgMain, color: textMain, showConfirmButton: false, showCloseButton: false, position: 'center-start', customClass: { popup: 'rounded-[1.5rem] shadow-2xl' } });
    },
