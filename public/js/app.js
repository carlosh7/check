...
import { Config } from './modules/core/Config.js?v=12.44.457';
import { AppStateManager } from './modules/core/State.js?v=12.44.457';
import { Constants } from './modules/utils/Constants.js?v=12.44.457';
import { RouterManager } from './modules/navigation/Router.js?v=12.44.457';
import { PersistenceManager } from './modules/navigation/Persistence.js?v=12.44.457';
import { ToastManager } from './modules/components/Toast.js?v=12.44.457';
import { ModalManager, hideModal } from './modules/components/Modal.js?v=12.44.457';
import { TableManager } from './modules/components/Table.js?v=12.44.457';
import { SidebarManager } from './modules/components/Sidebar.js?v=12.44.457';
import { FormManager } from './modules/components/Form.js?v=12.44.457';
import { DropdownManager } from './modules/components/Dropdown.js?v=12.44.457';
import { ViewManagerInstance } from './modules/views/ViewManager.js?v=12.44.457';
import { MyEventsViewInstance } from './modules/views/MyEvents.js?v=12.44.457';
import { AdminViewInstance } from './modules/views/Admin.js?v=12.44.457';
import { EventConfigViewInstance } from './modules/views/EventConfig.js?v=12.44.457';
import { SystemViewInstance } from './modules/views/System.js?v=12.44.457';
import { ApiServiceInstance } from './modules/services/ApiService.js?v=12.44.457';
import { AuthServiceInstance } from './modules/services/AuthService.js?v=12.44.457';
import { EventServiceInstance } from './modules/services/EventService.js?v=12.44.457';
import { GuestServiceInstance } from './modules/services/GuestService.js?v=12.44.457';

// DEBUG V12.44.457 - Si ves esto, el código nuevo se cargó
console.log('[INIT] app.js version 12.44.457 loaded');
console.log('[MODULES] Todos los módulos cargados v12.44.457');

/**
 * MASTER SCRIPT
 * Version: V12.44.457 (Neutral Dark)
 * Author: Carlos
 * 
 * Description: Sistema modular de gestión de asistencia con diseño Chrome Style.
 * 
 * Feature V12.44.457: Fix dependencia circular Router -> App.navigate -> Router
