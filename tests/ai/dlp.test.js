...
const { maskSensitiveData, SENSITIVE_DATA_PATTERNS } = require('../../src/middleware/ai-validation');

describe('AI DLP - Sensitive Data Masking', function() {

    test('should mask email addresses', function() {
        const result = maskSensitiveData('Contact me at user@example.com please');
    ...
    test('should mask phone numbers (10-15 digits)', function() {
        const result = maskSensitiveData('Call me at 551234567890');
    ...
    test('should mask RFC (tax ID)', function() {
        const result = maskSensitiveData('My RFC is ABCD123456XYZ');
    ...
    test('should mask CURP (18 digits)', function() {
        const result = maskSensitiveData('CURP: 123456789012345678');
    ...
    test('should mask credit card numbers (16 digits)', function() {
        const result = maskSensitiveData('Card: 1234567890123456');
    ...
    test('should NOT modify text without sensitive data', function() {
        const text = 'The event starts at 8 PM and ends at 10 PM';
    ...
    test('should mask multiple sensitive data occurrences', function() {
        const text = 'Email: a@b.com, Phone: 551234567890, Email2: c@d.com';
        const result = maskSensitiveData(text);
